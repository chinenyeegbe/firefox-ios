...
class BrowsingPDFTests: BaseTestCase {
    func testOpenPDFViewer() {
        ...
        // Swipe Up and Down
        let element = app/*@START_MENU_TOKEN@*/.otherElements["contentView"].webViews/*[[".otherElements[\"Web content\"].webViews",".otherElements[\"contentView\"].webViews",".webViews"],[[[-1,2],[-1,1],[-1,0]]],[1]]@END_MENU_TOKEN@*/.children(matching: .other).element
        element.swipeUp()
